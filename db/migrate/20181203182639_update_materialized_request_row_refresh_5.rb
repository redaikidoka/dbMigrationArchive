class UpdateMaterializedRequestRowRefresh5 < ActiveRecord::Migration[5.2]
  def up
    remove_column :materialized_request_rows, :received_on, :text
  ...
  def down
    add_column :materialized_request_rows, :received_on, :datetime
